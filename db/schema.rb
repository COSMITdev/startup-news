...
ActiveRecord::Schema.define(version: 20131101134211) do
  ...
  create_table "votes", force: true do |t|
    t.integer  "user_id"
    t.integer  "news_id"
    t.boolean  "is_up",      default: true, null: false
    t.string   "ip",         default: "",   null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "votes", ["news_id"], name: "index_votes_on_news_id", using: :btree
